...
### Files in static
This contains a few CSS styles. I reused the ones from the finance assignment done earlier.
...
- displaying tables and charts over norwegian government expenses as well
